...
clear;
d_msls = load('Data/082225_msls_r')
...
for pp = 1:rp_num
    for oo = 1:po_num
        [pp rp_num oo po_num]
        res_arr(pp,oo,1:9) = classifier_performance( ...
            800, d_msls.rp_arr(pp), d_msls.rs_inf_res(pp,oo), k_msls, d_msls.p_obs_arr(oo) ...
            );
        % Treating >19 as 'positive'
        res_arr(pp,oo,10:13) = OR_performance( ...
            d_msls.p_obs_arr(oo), ...
            res_arr(pp,oo,1), res_arr(pp,oo,2), res_arr(pp,oo,3), res_arr(pp,oo,4), ...
            48.42624147/241, 13.57375853/241, 166.57375853/241, 12.42624147/241 ... # X_pn, X_pp, X_sn, X_sp
            );
        % res_arr(pp,oo,13)
    end
end

save('Data/082225_msls_OR')

%%
% mpox updating new numbers
clear;
k_mpox = 0.3;
Compat_arr = compatible_par_inf( ...
    800, ...
    1-296/829, ... % 1 - primary/total
    1:.025:1.5, ...
    k_mpox, ...
    0.25:.025:1, ...
    'Data/082225_mpox_r' ...
